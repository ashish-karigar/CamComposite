//
//  CamCompositeCameraExtensionProvider.swift
...
class CamCompositeCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: CamCompositeCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = CamCompositeCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class CamCompositeCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? CamCompositeCameraExtensionDeviceSource else {
...
class CamCompositeCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: CamCompositeCameraExtensionDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = CamCompositeCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
